...
func GetAllUsers() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		total, err2 := userCollection.CountDocuments(ctx, bson.M{
			"name": "trongpq",
		})
		...
		c.JSON(http.StatusOK,
			responses.UserResponse{Status: http.StatusOK, Message: "success", Data: map[string]interface{}{"data": users, "total": total}},
		)
	}
}
